...
/// Tests hub, Liquid Glass style: entry point for the psychology test and
/// the observation (attentiveness) test — mirrors [SpeechHubScreen].
      ...
      body: Stack(
        children: [
              ...
              children: [
                ...
                GlassEntrance(
                  ...
                  child: _Option(
                    ...
                    description: l.psychologyTestSub,
                ...
                GlassEntrance(
                  ...
                  child: _Option(
                    ...
                    description: l.homeActionObservationSub,
                    gradient: const LinearGradient(
                      colors: [AppColors.success, AppColors.blue],
          ...
          Positioned(
            ...
            left: 0,
            right: 0,
            child: GlassTopChrome(offset: _scrollOffset, title: l.testsHub),
          ),
        ],
      ),
    );
